...
int main(int argc, char** argv) {
    ...
    // Boot the Pluto runtime: run init.lua (binary/endpoint allowlists, constants,
    // fs whitelist) and scan scripts/ for *.pluto + their meta tables.
    rana::LuaRuntime rt;
    if (!rt.init(cfg, err)) {
