...
//
// This is the ONLY place that knows about audio codecs/format; the socket
// daemon stays codec-free. Resampling and richer decode (opus, mp3, …) are
// extension points owned exclusively here.
